...
module.exports = function(app) {
    ...
    app.get('/schools/:schoolId/complexes/:complexId/students/parents', auth.check, parents.all);
    app.post('/schools/:schoolId/complexes/:complexId/students/parents', auth.check, parents.create);
    ...
    app.del('/schools/:schoolId/complexes/:complexId/students/:studentId/parents/:parentId', parents.parent, auth.check, parents.destroy);
