...
angular.module('aurea.communications').controller('CommunicationsCtrl', ['$scope', '$stateParams', 'SmartState', '_', 'Global', 'Communication', function ($scope, $stateParams, SmartState, _, Global, Communication) {
    $scope.global = Global;
